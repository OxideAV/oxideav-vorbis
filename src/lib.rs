...
pub use book_design::{
    ...
    redesign_codebook, stream_cost_bits, tally_floor1_packet, tally_residue_plans, BookDesignError,
    BookTallies, MAX_CODEWORD_LEN,
};
...
pub use residue_encode::{
    ...
    plan_vector_residue_rd, select_residue_config, PartitionClassChoice, ResidueConfigCandidate,
