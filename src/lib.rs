...
pub use encoder::{
    ...
    write_identification_header, write_mapping_header, write_mode_header, write_residue_body,
    write_residue_header, write_residue_partition, Floor1Packet, PackResidueClassError,
    PackResidueClassGroupsError, ResidueBodyShape, ResidueVectorPlan, WriteAudioPacketHeaderError,
